    ...
    public function show(string $token)
    {
        ...
        if ($participant->event?->id === 36) {
            $questions = collect([
                ...
                (object)['id'=>'e36_1','question'=>'Name','field_key'=>null,'type'=>'text','placeholder'=>'Enter your full name','help_text'=>null,'is_required'=>false,'section'=>'Participant Information','is_matrix'=>false,'matrix_items'=>null,'event_type'=>'conference'],
                ...
                (object)['id'=>'e36_3','question'=>'College/Department','field_key'=>null,'type'=>'text','placeholder'=>'Enter your college or department','help_text'=>null,'is_required'=>true,'section'=>'Participant Information','is_matrix'=>false,'matrix_items'=>null,'event_type'=>'conference'],
                (object)['id'=>'e36_4','question'=>'Position/Designation','field_key'=>null,'type'=>'text','placeholder'=>'Enter your position','help_text'=>null,'is_required'=>true,'section'=>'Participant Information','is_matrix'=>false,'matrix_items'=>null,'event_type'=>'conference'],
                // Event Details
