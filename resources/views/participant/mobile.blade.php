        ...
        <section class="survey-section">
            ...
            <div class="survey-card">
                ...
                @if ($certificateAvailable)
                    <a class="survey-button cert-download-btn" href="{{ route('participants.certificate.show', ['token' => $participant->digital_id_token, 'type' => $certificateType]) }}" download="Certificate.pdf" target="_blank">
                        ...
                        if (certSection) {
                            ...
                            if (certCard) {
                                ...
                                certCard.innerHTML = `
                                    ...
                                    <a class="survey-button cert-download-btn" href="${certUrl}" download="Certificate.pdf" target="_blank">Download Certificate</a>
                                    <p id="cert-ios-tip" style="display:none;font-size:12px;color:#10b981;text-align:center;margin-top:8px;">PDF opened in new tab. Tap the share icon and select \"Save to Files\" to keep it.</p>
                                `;
                            }
                        }
