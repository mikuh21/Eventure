...
<head>
    ...
    <title>Eventure Event Staff Credentials</title>
</head>
                    ...
                    <tr>
                        <td style="padding:24px;">
                            ...
                            <p style="margin:0 0 18px; font-size:14px; line-height:1.6; color:#1B6CA8;">
                                You are successfully registered for your Event Staff account. Use the password below to sign in.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f5faff; border:1px solid #bfdfff; border-radius:12px; margin:0 0 18px;">
                                <tr>
                                    <td style="padding:16px 18px;">
                                        <p style="margin:0 0 10px; font-size:11px; letter-spacing:0.09em; text-transform:uppercase; color:#5BA4CF; font-weight:700;">Account Details</p>
                                        <p style="margin:0 0 6px; font-size:13px; color:#0A2342;"><strong>Name:</strong> {{ $user->name }}</p>
                                        <p style="margin:0 0 6px; font-size:13px; color:#0A2342;"><strong>Email:</strong> {{ $user->email }}</p>
                                        <p style="margin:0; font-size:13px; color:#0A2342;"><strong>Password:</strong> {{ $password }}</p>
                                    </td>
                                </tr>
                            </table>

                            <p style="margin:0 0 12px; font-size:14px; color:#1B6CA8;">You can now log in to your Event Staff account:</p>

                            <p style="margin:0 0 14px;">
                                <a href="{{ route('login') }}" style="display:inline-block; background:#0A2342; color:#ffffff; text-decoration:none; padding:12px 18px; border-radius:10px; font-size:14px; font-weight:700;">Login to Eventure</a>
                            </p>
