                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-1 text-sm" style="color:rgba(255,255,255,0.6)">
                                    ...
                                    @if($event->type === 'conference' && $event->theme)
                                        <p><span class="icon-orange" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M9 18h6v1a1 1 0 0 1-1 1H10a1 1 0 0 1-1-1v-1Zm3-3a5 5 0 0 0 5-5c0-2.76-2.24-5-5-5S7 7.24 7 10a5 5 0 0 0 5 5Zm2-1h-4a1 1 0 0 1-1-1 3 3 0 0 1 6 0 1 1 0 0 1-1 1Z"></path><path d="M12 5v2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></span> {{ $event->theme }}</p>
                                    @endif
                                    @if($event->type === 'conference' && $event->keywords)
                                        <p><span class="icon-orange" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M7 14a3 3 0 1 1 0-6 3 3 0 0 1 0 6Zm10-6h-2a1 1 0 0 0 0 2h1.28a1 1 0 0 1 .71.29l1.41 1.41a1 1 0 0 1 0 1.42l-3.17 3.17a1 1 0 0 1-1.42 0l-1.41-1.41a1 1 0 0 1-.29-.71V14a1 1 0 0 0-2 0v2a1 1 0 0 0 .29.71l1.41 1.41a3 3 0 0 0 4.24 0l3.17-3.17a3 3 0 0 0 0-4.24l-1.41-1.41A1 1 0 0 0 17 8Z"></path></svg></span> {{ is_array($event->keywords) ? implode(', ', $event->keywords) : $event->keywords }}</p>
                                    @endif
                        ...
                        <div class="card lift-hover reveal rounded-2xl p-6 flex flex-col md:flex-row md:items-center gap-6 hover:brightness-110 transition" data-reveal>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex flex-wrap gap-4 mt-1 text-sm" style="color:rgba(255,255,255,0.6)">
                                    ...
                                    @if($event->type === 'conference' && $event->theme)
                                        <span><span class="icon-orange" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M9 18h6v1a1 1 0 0 1-1 1H10a1 1 0 0 1-1-1v-1Zm3-3a5 5 0 0 0 5-5c0-2.76-2.24-5-5-5S7 7.24 7 10a5 5 0 0 0 5 5Zm2-1h-4a1 1 0 0 1-1-1 3 3 0 0 1 6 0 1 1 0 0 1-1 1Z"></path><path d="M12 5v2" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></span> {{ $event->theme }}</span>
                                    @endif
                                    @if($event->type === 'conference' && $event->keywords)
                                        <span><span class="icon-orange" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M7 14a3 3 0 1 1 0-6 3 3 0 0 1 0 6Zm10-6h-2a1 1 0 0 0 0 2h1.28a1 1 0 0 1 .71.29l1.41 1.41a1 1 0 0 1 0 1.42l-3.17 3.17a1 1 0 0 1-1.42 0l-1.41-1.41a1 1 0 0 1-.29-.71V14a1 1 0 0 0-2 0v2a1 1 0 0 0 .29.71l1.41 1.41a3 3 0 0 0 4.24 0l3.17-3.17a3 3 0 0 0 0-4.24l-1.41-1.41A1 1 0 0 0 17 8Z"></path></svg></span> {{ is_array($event->keywords) ? implode(', ', $event->keywords) : $event->keywords }}</span>
                                    @endif
