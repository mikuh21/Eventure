                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-1 text-sm" style="color:rgba(255,255,255,0.6)">
                                    ...
                                    @if(in_array($event->attendance_type, ['virtual', 'both']) && $event->meet_link)
                                        <p><a href="{{ $event->meet_link }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1 underline hover:opacity-80 transition"><span class="icon-orange" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M23 7l-7 5 7 5V7z"></path><rect x="1" y="5" width="15" height="14" rx="2" ry="2"></rect></svg></span> Meet Link</a></p>
                                    @endif
