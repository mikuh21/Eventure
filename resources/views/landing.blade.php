                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-1 text-sm" style="color:rgba(255,255,255,0.6)">
                                    ...
                                    @if($event->type === 'conference' && $event->template_file_path)
                                        <p><a href="https://sesmcvjwmkphgkzawewn.supabase.co/storage/v1/object/public/event-templates/{{ $event->template_file_path }}" download="Conference-Paper-Template.{{ pathinfo($event->template_file_path, PATHINFO_EXTENSION) }}" class="inline-flex items-center gap-1 underline hover:opacity-80 transition"><span class="icon-orange" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline><path d="M9 15l3 3 5-5"></path></svg></span> Conference Paper Template</a></p>
                                    @endif
                                </div>
                        ...
                        <div class="card lift-hover reveal rounded-2xl p-6 flex flex-col md:flex-row md:items-center gap-6 hover:brightness-110 transition" data-reveal>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex flex-wrap gap-4 mt-1 text-sm" style="color:rgba(255,255,255,0.6)">
                                    ...
                                    @endif
                                    @if($event->type === 'conference' && $event->template_file_path)
                                        <a href="https://sesmcvjwmkphgkzawewn.supabase.co/storage/v1/object/public/event-templates/{{ $event->template_file_path }}" download="Conference-Paper-Template.{{ pathinfo($event->template_file_path, PATHINFO_EXTENSION) }}" class="inline-flex items-center gap-1 underline hover:opacity-80 transition"><span class="icon-orange" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline><path d="M9 15l3 3 5-5"></path></svg></span> Conference Paper Template</a>
                                    @endif
                                </div>
                            </div>
                        </div>
