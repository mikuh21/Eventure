...
@section('content')
        ...
        <form class="edit-event-form" action="{{ route('events.update', $event) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="field" id="meet-link-field" style="display: {{ in_array($event->attendance_type, ['virtual', 'both']) ? 'block' : 'none' }};">
                ...
                <div style="position: relative;">
                    <input id="meet_link" name="meet_link" type="url" value="{{ old('meet_link', $event->meet_link) }}" placeholder="https://meet.google.com/..." style="padding-right: 40px;">
                ...
                @if ($event->type === 'conference' && $event->template_file_path)
                    <div class="mt-2">
                        ...
                        <a href="{{ route('events.download-template', $event) }}" class="text-blue-600 underline text-sm flex items-center gap-1">
                            ...
                            {{ $event->template_file_name ?? basename($event->template_file_path) }}
                        </a>
                    </div>
                @endif
            </div>
                ...
                @if ($event->program_file_path)
                    <div class="template-preview" style="margin-bottom: 1rem;">
                        ...
                        <div>
                            ...
                            <a href="/events/{{ $event->id }}/program/download" class="text-blue-600 underline text-sm flex items-center gap-1">
                                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                                    <path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path>
                                    <polyline points="13 2 13 9 20 9"></polyline>
                                </svg>
            ...
            <div class="field" id="template-url-field">
                ...
                <div style="position: relative;">
                    <input id="template_url" name="template_url" type="url" value="{{ old('template_url', $event->template_url ?? '') }}" placeholder="https://drive.google.com/..." style="padding-right: 40px;">
    ...
    <div style="display:flex;align-items:center;gap:8px;">
        ...
        <span style="font-size:13px;color:#6b7280;">Automatically open at 11PM on event end date if not opened manually</span>
            ...
            <div class="form-group">
    <label for="auto_approve">Auto-Approve Participants</label>
    <div style="display:flex;align-items:center;gap:8px;">
    ...
    <script>
        (function () {
            ...
            // iOS fallback: enforce date validation for standalone edit page
