            ...
            <div class="form-actions span-2">
                <div class="form-group" style="margin-bottom:16px;">
                    <label style="display:flex;align-items:center;gap:10px;font-weight:600;cursor:pointer;">
                        ...
                        <input type="checkbox" name="auto_activate_evaluation" value="1" {{ old('auto_activate_evaluation', $event->auto_activate_evaluation ?? true) ? 'checked' : '' }} style="width:18px;height:18px;cursor:pointer;">
