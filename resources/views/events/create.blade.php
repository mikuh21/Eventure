        ...
        <form class="create-event-form" action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom:16px;">
                <label style="display:flex;align-items:center;gap:8px;font-weight:500;font-size:14px;cursor:pointer;color:#374151;">
                    ...
                    <input type="checkbox" name="auto_activate_evaluation" value="1" {{ old('auto_activate_evaluation', '1') == '1' ? 'checked' : '' }} style="width:14px;height:14px;cursor:pointer;flex-shrink:0;">
