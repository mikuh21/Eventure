...
@section('content')
    ...
    <div style="display:flex;align-items:center;gap:8px;">
        ...
        <input type="checkbox" id="auto_activate_evaluation" name="auto_activate_evaluation" value="1" {{ old('auto_activate_evaluation', '1') == '1' ? 'checked' : '' }} style="width:14px;height:14px;cursor:pointer;flex-shrink:0;">
    ...
    <div style="display:flex;align-items:center;gap:8px;">
        ...
        <input type="checkbox" id="auto_approve" name="auto_approve" value="1" {{ old('auto_approve', false) ? 'checked' : '' }} style="width:14px;height:14px;cursor:pointer;flex-shrink:0;">
        <span style="font-size:13px;color:#6b7280;">Automatically approve participants and guests who register through the home page</span>
    </div>
</div>
